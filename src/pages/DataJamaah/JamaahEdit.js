    ...
    return (
        <View style={{ flex: 1, backgroundColor: "black" }}>
            ...
            {open && <ScrollView style={{ padding: 20, }}>
                ...
                {/* NAMA LENGKAP */}
                <MyInputSecond value={kirim.nama_jamaah} onChangeText={x => setKirim({ ...kirim, nama_jamaah: x })} label="Nama Lengkap" placeholder="Nama Lengkap" />

                <MyGap jarak={10} />

                {/* NAMA LENGKAP */}
                <MyInputSecond label="Alamat" onChangeText={x => setKirim({ ...kirim, alamat_jamaah: x })} value={kirim.alamat_jamaah} placeholder="Alamat Lengkap" />
                <MyGap jarak={10} />
                {/* NAMA LENGKAP */}
                <MyInputSecond keyboardType='phone-pad' label="Telepon" placeholder="Nomor telepon" onChangeText={x => setKirim({ ...kirim, telepon_jamaah: x })} value={kirim.telepon_jamaah} />

                <MyGap jarak={10} />
                <MyInputSecond label="Nomor KTP" keyboardType='number-pad' value={kirim.nomor_ktp} maxLength={16} placeholder="Nomor KTP" onChangeText={x => setKirim({ ...kirim, nomor_ktp: x })} />
                <MyGap jarak={10} />
                <Text style={{
                ...
                <MyGap jarak={10} />
                {/* NAMA LENGKAP */}
                <MyInputSecond value={kirim.nomor_paspor} onChangeText={x => setKirim({ ...kirim, nomor_paspor: x })} label="Nomor Paspor" placeholder="Nomor Paspor" />
                <MyGap jarak={10} />
                <Text style={{
                    fontFamily: fonts.secondary[600],
                    fontSize: MyDimensi / 4,
